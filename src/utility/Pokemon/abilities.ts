...
export class Abilities {
  ...
  private readonly flavor_text_entries: AbilityFlavorText[] | null;
  private readonly pokemon: AbilityPokemon[] | null;
   ...
   */
  public get getFlavorTextEntries(): AbilityFlavorText[] | null {
   ...
   */
  public get getPokemons(): AbilityPokemon[] | null {
    return this.pokemon;
  }
}
